        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $action = "<div class='d-flex'>
                        <a href='".route('admin.coupons.edit', $query->id)."' class='btn btn-primary'><i class='far fa-edit'></i></a>
                        <a href='".route('admin.coupons.destroy', $query->id)."' class='btn btn-danger ml-2 delete-item'><i class='far fa-trash-alt'></i></a>
                    </div>";
                return $action;
            })
