...
<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a href="{{route('vendor.products.index')}}"><i class="far fa-box"></i> Vendor Products</a></li>
      <li><a href="{{route('vendor.shop-profile.index')}}"><i class="far fa-user"></i> Saller Profile</a></li>
