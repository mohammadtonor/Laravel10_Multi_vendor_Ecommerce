                                ...
                                <div class="exzoom_img_box">
                                    ...
                                    <ul class='exzoom_img_ul'>
                                        ...
                                        @foreach ($product->productImageGallery as $imageGallery)
                                            <li><img class="zoom ing-fluid w-100" src="{{asset($imageGallery->image)}}" alt="product"></li>
                                        @endforeach
                                    </ul>
                                </div>
                    ...
                    <div class="col-xl-5 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            <p class="review">
                             ...
                             <p style="width: 100%;">{!! $product->short_description !!}</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    ...
                                                    <p><span>Address:</span> {{$product->vendor->address}}(US)</p>
