                                ...
                                <div class="wsus__product_item">
                                    ...
                                    <div class="wsus__product_details">
                                        ...
                                        <form class="shopping-cart-form">
                                            ...
                                            @endforeach
                                            <input hidden name="qty" type="text" min="1" max="100" value="1" />
                                            <button class="add_cart" type="submit" >add to cart</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="wsus__offer_progress">
                                    <p><span>Sold 91</span> <span>Total {{$product->qty}}</span></p>
                                    @if (checkDiscount($product))
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar" style="width: {{(int)calculateDiscount($product)}}%;" aria-valuenow="{{(int)calculateDiscount($product)}}"
                                                aria-valuemin="0" aria-valuemax="100">{{(int)calculateDiscount($product)}}%</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-12 col-sm-10 col-md-8 col-lg-6 m-auto display">
                                <div class="wsus__quick_view_img">
                                    ...
                                    <div class="row modal_slider">
                                        ...
                                        @foreach ($product->productImageGallery as $imageGallery)
                                            <div class="col-xl-12">
                                                <div class="modal_slider_img">
