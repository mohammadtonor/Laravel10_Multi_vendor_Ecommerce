            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        <li><a class="{{count($category->subCategories) > 0 ? 'wsus__droap_arrow' : ''}} " href="#"><i class="fal {{$category->icon}}"></i> {!! $category->name !!} </a>
                            @if (count($category->subCategories) > 0)
                                <ul class="wsus_menu_cat_droapdown">
                                    @foreach ($category->subCategories as $subCategory)
                                    <li><a href="#">{!! $subCategory->name !!} <i class="fas {{count($subCategory->childCategories) > 0 ? 'fa-angle-right' : ''}} "></i></a>
